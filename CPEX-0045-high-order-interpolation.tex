...
\textbf{Editorial convention.}~Indented passages set in \emph{quotation marks}
(``\dots'')\ in the sections that follow reproduce text \emph{verbatim} from
CPEX-0045~v2 (K.~Hillewaert, Cenaero).  The surrounding prose is v3
commentary that formalises, extends, or clarifies the v2 wording.  This
preserves the original proposal language for traceability while letting v3
add the implementation specification adopted in CGNS~v5.0.%
}}
